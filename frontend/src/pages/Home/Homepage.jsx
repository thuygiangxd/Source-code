      ...
      <main>
        ...
        <section className="section" id="tuyendung">
          <div className="band band--purple">
            ...
            <div className="hero-cta">
              <button className="btn btn-light" onClick={() => navigate('/job-guest')}>Ứng tuyển ngay</button>
            </div>
          </div>
        </section>
        ...
        <section className="section" id="dangky">
          <div className="band">
            ...
            <div className="hero-cta">
              <a className="btn btn-primary" href="/signup">Tạo tài khoản</a>
              <a className="btn btn-ghost" href="/login">Tôi đã có tài khoản</a>
            </div>
          </div>
        </section>
      </main>
